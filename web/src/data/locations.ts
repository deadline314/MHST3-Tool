...
const LOCATION_RAW: Record<string, MonsterLocation> = {
  ...
  "Afflicted Chatacabra": { locations: "亞茲萊爾領域：灰之道（劇情）", obtainMethod: "-（劇情Boss）" },
  "Afflicted Yian Kut-Ku": { locations: "亞茲萊爾領域（劇情）", obtainMethod: "-（劇情Boss）" },
  "Afflicted Velocidrome": { locations: "亞茲萊爾領域（劇情）", obtainMethod: "-（劇情Boss）" },
  "Afflicted Gypceros": { locations: "亞茲萊爾領域（劇情）", obtainMethod: "-（劇情Boss）" },
  "Afflicted Somnacanth": { locations: "卡納爾塔密林（劇情）", obtainMethod: "-（劇情Boss）" },
  "Afflicted Great Izuchi": { locations: "卡納爾塔密林（劇情）", obtainMethod: "-（劇情Boss）" },
  "Afflicted Aknosom": { locations: "卡納爾塔密林（劇情）", obtainMethod: "-（劇情Boss）" },
  "Afflicted Nerscylla": { locations: "亞茲萊爾領域：明鏡之湖", obtainMethod: "-（解鎖營地）" },
  "Afflicted Brachydios": { locations: "亞茲萊爾領域：厄石之森", obtainMethod: "-（解鎖營地）" },
  "Afflicted Paolumu": { locations: "亞茲萊爾領域：巨樹山口", obtainMethod: "-（解鎖營地）" },
  "Afflicted Bishaten": { locations: "卡納爾塔密林：啼吠之森", obtainMethod: "-（解鎖營地）" },
  "Afflicted Tetranadon": { locations: "卡納爾塔密林：瀑隱冰窟", obtainMethod: "-（解鎖營地）" },
  "Afflicted Espinas": { locations: "卡納爾塔密林：嚴界山", obtainMethod: "-（解鎖營地）" },
  "Afflicted Tobi-Kadachi": { locations: "卡納爾塔密林：恩惠之丘", obtainMethod: "-（解鎖營地）" },
  "Afflicted Barroth": { locations: "塔基爾坎：巨龍之骸", obtainMethod: "-（解鎖營地）" },
  "Afflicted Glavenus": { locations: "塔基爾坎：天惠砂海", obtainMethod: "-（解鎖營地）" },
  "Afflicted Gravios": { locations: "塔基爾坎：奇岩帶", obtainMethod: "-（解鎖營地）" },
  "Afflicted Legiana": { locations: "桑提亞：榮都古道", obtainMethod: "-（解鎖營地）" },
  "Afflicted Magnamalo": { locations: "桑提亞：聖域・舊都拉茲里恩", obtainMethod: "-（解鎖營地）" },
  "Afflicted Yama Tsukami": { locations: "-（劇情Boss）", obtainMethod: "-（劇情Boss）" },
  "Afflicted Ajarakan": { locations: "塔基爾坎（劇情）", obtainMethod: "-（劇情Boss）" },
  "Afflicted Rakna-Kadaki": { locations: "塔基爾坎（劇情）", obtainMethod: "-（劇情Boss）" },
  "Afflicted Blangonga": { locations: "桑提亞（劇情）", obtainMethod: "-（劇情Boss）" },
};
