...
const LOCATION_RAW: Record<string, MonsterLocation> = {
  ...
  "Canyne": { locations: "卡納爾塔密林：恩惠之丘", obtainMethod: "侵獸青熊獸戰後的危惧種巢穴取得蛋" },
  "Tobi-Kadachi": { locations: "亞茲萊爾領域：巨樹山口", obtainMethod: "怪物巢穴取得蛋並孵化" },
  "Zinogre": { locations: "-（危惧種巢穴）", obtainMethod: "塔基爾坎-奇岩帶西側高台的危惧種巢穴取得蛋並孵化" },
  ...
  "Lagiacrus": { locations: "-（危惧種巢穴）", obtainMethod: "亞茲萊爾領域-明鏡之湖北側洞窟的危惧種巢穴取得蛋並孵化" },
  "Ivory Lagiacrus": { locations: "-（突然變異）", obtainMethod: "突然變異後加入生態系，再從怪物巢穴取得蛋並孵化" },
  "Mizutsune": { locations: "-（危惧種巢穴）", obtainMethod: "卡納爾塔密林北側瀑隱冰窟的危惧種巢穴取得蛋並孵化" },
  ...
  "Rathian": { locations: "-（危惧種巢穴）", obtainMethod: "亞茲萊爾領域的危惧種巢穴取得蛋並孵化" },
  ...
  "Barioth": { locations: "-（危惧種巢穴）", obtainMethod: "桑提亞：冰河北東的危惧種巢穴取得蛋並孵化" },
  "Sand Barioth": { locations: "-（突然變異）", obtainMethod: "突然變異（冰牙龍生態等級A），再從怪物巢穴取得蛋並孵化" },
  "Nargacuga": { locations: "-（危惧種巢穴）", obtainMethod: "卡納爾塔密林-恩惠之丘東側的危惧種巢穴取得蛋並孵化" },
  ...
  "Astalos": { locations: "-（危惧種巢穴）", obtainMethod: "亞茲萊爾領域-明鏡之湖北西崖奧的危惧種巢穴取得蛋並孵化" },
  "Boltreaver Astalos": { locations: "-（突然變異）", obtainMethod: "突然變異（電龍生態等級S + 雷屬性區域且雷屬性魔物3體以上）" },
  "Tigrex": { locations: "-（危惧種巢穴）", obtainMethod: "塔基爾坎-巨龍之骸南東的危惧種巢穴取得蛋並孵化" },
