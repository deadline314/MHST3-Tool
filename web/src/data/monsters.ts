...
const RAW_DATA: { category: string; monsters: RawMonster[] }[] = [
  ...
  },
  {
    ...
    monsters: [
      ...
      { name: "凶異棘龍", nameEN: "Feral Espinas", nameJP: "凶異エスピナス", species: "飛龍種", normalAttack: "力量", specialAttacks: "[憤怒]: 速度 / [暴走]: 力量" },
      ...
      { name: "凶異妃蜘蛛", nameEN: "Feral Rakna-Kadaki", nameJP: "凶異ヤツカダキ", species: "鋏角種", normalAttack: "技巧", specialAttacks: "[蓄絲(腳)]: 技巧 / [蓄絲(繭)]: 速度" },
