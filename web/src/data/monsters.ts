...
const RAW_DATA: { category: string; monsters: RawMonster[] }[] = [
  ...
  },
  {
    ...
    monsters: [
      ...
      { name: "雷顎龍", nameEN: "Fulgur Anjanath", nameJP: "アンジャナフ亜種", species: "獸龍種", normalAttack: "力量", specialAttacks: "[帶電]: 速度 / [強帶電]: 速度" },
  ...
  },
  {
    ...
    monsters: [
      ...
      { name: "溟波龍", nameEN: "Namielle", nameJP: "ネロミェール", species: "古龍種", normalAttack: "技巧", specialAttacks: "[流水纏身]: 速度 / [枯竭]: 力量 / [溟帶電]: 速度" },
      ...
      { name: "界龍", nameEN: "Aenshin", nameJP: "アエンシン", species: "古龍種", normalAttack: "技巧", specialAttacks: "[厄石防護]: 技巧 / [厄石解放]: 力量 / [封龍]: 力量" },
  ...
  },
  {
    ...
    monsters: [
      ...
      { name: "侵獸奇怪龍", nameEN: "Invasive Khezu", nameJP: "侵獣フルフル", species: "飛龍種", normalAttack: "技巧", specialAttacks: "[侵化]: 力量" },
