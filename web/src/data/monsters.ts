...
const RAW_DATA: { category: string; monsters: RawMonster[] }[] = [
  ...
  },
  {
    ...
    monsters: [
      ...
      { name: "侵獸影蜘蛛", nameEN: "Invasive Nerscylla", nameJP: "侵獣ネルスキュラ", species: "蟲蛛種", normalAttack: "技巧", specialAttacks: "[侵化]: 速度" },
  ...
  },
  {
    category: "兇異魔物",
    monsters: [
      { name: "兇異纏蛙", nameEN: "Afflicted Chatacabra", nameJP: "凶異チャタカブラ", species: "兩棲種", normalAttack: "力量", specialAttacks: "[鑛物纏繞]: 技巧" },
...
const RELATED_FAMILIES: string[][] = [
  ...
  ["Nerscylla", "Shrouded Nerscylla", "Afflicted Nerscylla", "Invasive Nerscylla"],
