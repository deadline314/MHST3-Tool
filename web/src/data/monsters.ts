...
const ICON_OVERRIDES: Record<string, string> = {
  ...
  "Exotic Velocidrome": "Invasive_Arzuros",
  "Exotic Seregios": "Invasive_Seregios",
  "Exotic Legiana": "Feral_Legiana",
  "Exotic Nibelsnarf": "Invasive_Nerscylla",
  ...
  "Afflicted Chatacabra": "Chatacabra",
  "Afflicted Yian Kut-Ku": "Yian_Kut-Ku",
  "Afflicted Velocidrome": "Velocidrome",
  "Afflicted Gypceros": "Gypceros",
  "Afflicted Somnacanth": "Somnacanth",
  "Afflicted Great Izuchi": "Great_Izuchi",
  "Afflicted Aknosom": "Aknosom",
  "Afflicted Nerscylla": "Nerscylla",
  "Afflicted Brachydios": "Brachydios",
  "Afflicted Paolumu": "Paolumu",
  "Afflicted Bishaten": "Bishaten",
  "Afflicted Tetranadon": "Tetranadon",
  "Afflicted Espinas": "Espinas",
  "Afflicted Tobi-Kadachi": "Tobi-Kadachi",
  "Afflicted Barroth": "Barroth",
  "Afflicted Glavenus": "Glavenus",
  "Afflicted Gravios": "Gravios",
  "Afflicted Legiana": "Legiana",
  "Afflicted Magnamalo": "Magnamalo",
  "Afflicted Yama Tsukami": "Yama_Tsukami_2",
  "Afflicted Ajarakan": "Ajarakan",
  "Afflicted Rakna-Kadaki": "Rakna-Kadaki",
  "Afflicted Blangonga": "Blangonga",
};
...
const RAW_DATA: { category: string; monsters: RawMonster[] }[] = [
  ...
  },
  {
    category: "鳥龍種",
    monsters: [
      { name: "搔鳥", nameEN: "Kulu-Ya-Ku", nameJP: "クルルヤック", species: "鳥龍種", normalAttack: "技巧", specialAttacks: "[持石]: 力量" },
      ...
      { name: "毒妖鳥", nameEN: "Pukei-Pukei", nameJP: "プケプケ", species: "鳥龍種", normalAttack: "技巧", specialAttacks: "[異常化]: 速度 / [憤怒]: 力量" },
      { name: "彩鳥", nameEN: "Gypceros", nameJP: "ゲリョス", species: "鳥龍種", normalAttack: "力量", specialAttacks: "[憤怒]: 技巧" },
  ...
  },
  {
    ...
    monsters: [
      ...
      { name: "桃毛獸", nameEN: "Bishaten", nameJP: "ビシュテンゴ", species: "牙獸種", normalAttack: "技巧", specialAttacks: "[異常化]: 速度" },
      { name: "血橙獸", nameEN: "Blood Orange Bishaten", nameJP: "ビシュテンゴ亜種", species: "牙獸種", normalAttack: "速度", specialAttacks: "[憤怒]: 力量" },
      { name: "雪獅子王", nameEN: "Blangonga", nameJP: "ドドブランゴ", species: "牙獸種", normalAttack: "力量", specialAttacks: "[憤怒]: 速度" },
      { name: "雪鬼獸", nameEN: "Goss Harag", nameJP: "ゴシャハギ", species: "牙獸種", normalAttack: "力量", specialAttacks: "[冰棍]: 技巧 / [冰刃]: 速度" },
  ...
  },
  {
    ...
    monsters: [
      ...
      { name: "碎龍", nameEN: "Brachydios", nameJP: "ブラキディオス", species: "獸龍種", normalAttack: "力量", specialAttacks: "[黏菌活化]: 速度 / [憤怒]: 力量" },
    ],
  },
  {
    category: "魚龍種",
  ...
  },
  {
    category: "海龍種",
    monsters: [
      { name: "海龍", nameEN: "Lagiacrus", nameJP: "ラギアクルス", species: "海龍種", normalAttack: "力量", specialAttacks: "[異常化]: 速度 / [帶電]: 技巧" },
      { name: "白海龍", nameEN: "Ivory Lagiacrus", nameJP: "ラギアクルス亜種", species: "海龍種", normalAttack: "速度", specialAttacks: "[異常化]: 力量 / [帶電]: 技巧" },
      ...
      { name: "泥翁龍", nameEN: "Almudron", nameJP: "オロミドロ", species: "海龍種", normalAttack: "力量", specialAttacks: "[異常化]: 技巧 / [泥球]: 速度" },
      { name: "水獸王", nameEN: "Royal Ludroth", nameJP: "ロアルドロス", species: "海龍種", normalAttack: "力量", specialAttacks: "[憤怒]: 技巧" },
      { name: "紫水獸", nameEN: "Purple Ludroth", nameJP: "ロアルドロス亜種", species: "海龍種", normalAttack: "力量", specialAttacks: "[憤怒]: 技巧" },
      { name: "人魚龍", nameEN: "Somnacanth", nameJP: "イソネミクニ", species: "海龍種", normalAttack: "技巧", specialAttacks: "[異常化]: 速度" },
      { name: "冰人魚龍", nameEN: "Aurora Somnacanth", nameJP: "イソネミクニ亜種", species: "海龍種", normalAttack: "技巧", specialAttacks: "[異常化]: 速度" },
    ],
  },
  {
    category: "甲殼種",
    monsters: [
      { name: "盾蟹", nameEN: "Ceanataur", nameJP: "ガミザミ", species: "甲殼種", normalAttack: "力量", specialAttacks: "-" },
      { name: "鎌蟹", nameEN: "Shogun Ceanataur", nameJP: "ショウグンギザミ", species: "甲殼種", normalAttack: "速度", specialAttacks: "[異常化]: 技巧 / [殼破壞]: 力量" },
    ],
  },
  {
    category: "蟲蛛種",
  ...
  },
  {
    category: "蛇龍種",
    monsters: [
      { name: "潛口龍", nameEN: "Nibelsnarf", nameJP: "ハプルボッカ", species: "蛇龍種", normalAttack: "技巧", specialAttacks: "[異常化]: 速度" },
      { name: "毒翼蛇", nameEN: "Remobra", nameJP: "ガブラス", species: "蛇龍種", normalAttack: "技巧", specialAttacks: "-" },
    ],
  },
  {
    category: "飛龍種",
    monsters: [
      ...
      { name: "風漂龍", nameEN: "Legiana", nameJP: "レイギエナ", species: "飛龍種", normalAttack: "速度", specialAttacks: "[異常化]: 力量 / [飛行]: 技巧" },
      ...
      { name: "白電龍", nameEN: "Khezu", nameJP: "フルフル", species: "飛龍種", normalAttack: "技巧", specialAttacks: "[帶電]: 力量" },
      { name: "紅電龍", nameEN: "Red Khezu", nameJP: "フルフル亜種", species: "飛龍種", normalAttack: "技巧", specialAttacks: "[帶電]: 力量 / [放電]: 速度" },
      { name: "棘龍", nameEN: "Espinas", nameJP: "エスピナス", species: "飛龍種", normalAttack: "力量", specialAttacks: "[憤怒]: 速度 / [暴走]: 力量" },
      { name: "雷電龍", nameEN: "Rey Dau", nameJP: "レ・ダウ", species: "飛龍種", normalAttack: "速度", specialAttacks: "[憤怒]: 力量" },
  ...
  },
  {
    category: "古龍種",
    monsters: [
      { name: "冰咒龍", nameEN: "Velkhana", nameJP: "イヴェルカーナ", species: "古龍種", normalAttack: "技巧", specialAttacks: "[異常化]: 速度 / [冰霜鎧]: 技巧 / [冰霧]: 力量" },
      { name: "溟波龍", nameEN: "Namielle", nameJP: "ネロミェール", species: "古龍種", normalAttack: "技巧", specialAttacks: "[蓄水]: 速度 / [枯竭]: 力量" },
      { name: "爵銀龍", nameEN: "Malzeno", nameJP: "メルゼナ", species: "古龍種", normalAttack: "速度", specialAttacks: "[異常化]: 技巧 / [血氣]: 速度" },
  ...
  },
  {
    ...
    monsters: [
      ...
      { name: "侵獸潛口龍", nameEN: "Exotic Nibelsnarf", nameJP: "珍種ハプルボッカ", species: "蛇龍種", normalAttack: "技巧", specialAttacks: "[異常化]: 技巧" },
  ...
  },
  {
    category: "兇異魔物",
    monsters: [
      { name: "兇異纏蛙", nameEN: "Afflicted Chatacabra", nameJP: "凶異チャタカブラ", species: "兩棲種", normalAttack: "力量", specialAttacks: "[鑛物纏]: 技巧" },
      { name: "兇異怪鳥", nameEN: "Afflicted Yian Kut-Ku", nameJP: "凶異イャンクック", species: "鳥龍種", normalAttack: "技巧", specialAttacks: "[憤怒]: 速度" },
      { name: "兇異迅猛龍王", nameEN: "Afflicted Velocidrome", nameJP: "凶異ドスランポス", species: "鳥龍種", normalAttack: "速度", specialAttacks: "[憤怒]: 力量" },
      { name: "兇異彩鳥", nameEN: "Afflicted Gypceros", nameJP: "凶異ゲリョス", species: "鳥龍種", normalAttack: "力量", specialAttacks: "[憤怒]: 技巧" },
      { name: "兇異人魚龍", nameEN: "Afflicted Somnacanth", nameJP: "凶異イソネミクニ", species: "海龍種", normalAttack: "技巧", specialAttacks: "[尾立]: 速度" },
      { name: "兇異鐮鼬龍王", nameEN: "Afflicted Great Izuchi", nameJP: "凶異オサイズチ", species: "鳥龍種", normalAttack: "速度", specialAttacks: "[憤怒]: 力量" },
      { name: "兇異傘鳥", nameEN: "Afflicted Aknosom", nameJP: "凶異アケノシルム", species: "鳥龍種", normalAttack: "技巧", specialAttacks: "[憤怒]: 力量" },
      { name: "兇異影蜘蛛", nameEN: "Afflicted Nerscylla", nameJP: "凶異ネルスキュラ", species: "蟲蛛種", normalAttack: "技巧", specialAttacks: "[異常化]: 速度" },
      { name: "兇異碎龍", nameEN: "Afflicted Brachydios", nameJP: "凶異ブラキディオス", species: "獸龍種", normalAttack: "力量", specialAttacks: "[黏菌活化]: 速度 / [憤怒]: 力量" },
      { name: "兇異浮空龍", nameEN: "Afflicted Paolumu", nameJP: "凶異パオウルムー", species: "飛龍種", normalAttack: "技巧", specialAttacks: "[飛行]: 速度" },
      { name: "兇異桃毛獸", nameEN: "Afflicted Bishaten", nameJP: "凶異ビシュテンゴ", species: "牙獸種", normalAttack: "技巧", specialAttacks: "[異常化]: 速度" },
      { name: "兇異河童蛙", nameEN: "Afflicted Tetranadon", nameJP: "凶異ヨツミワドウ", species: "兩棲種", normalAttack: "力量", specialAttacks: "[膨脹]: 技巧" },
      { name: "兇異棘龍", nameEN: "Afflicted Espinas", nameJP: "凶異エスピナス", species: "飛龍種", normalAttack: "力量", specialAttacks: "[憤怒]: 速度 / [暴走]: 力量" },
      { name: "兇異飛雷龍", nameEN: "Afflicted Tobi-Kadachi", nameJP: "凶異トビカガチ", species: "牙龍種", normalAttack: "速度", specialAttacks: "[帶電]: 技巧" },
      { name: "兇異土砂龍", nameEN: "Afflicted Barroth", nameJP: "凶異ボルボロス", species: "獸龍種", normalAttack: "速度", specialAttacks: "[泥鎧]: 技巧" },
      { name: "兇異斬龍", nameEN: "Afflicted Glavenus", nameJP: "凶異ディノバルド", species: "獸龍種", normalAttack: "速度", specialAttacks: "[蓄熱]: 技巧 / [紅刃]: 力量" },
      { name: "兇異鎧龍", nameEN: "Afflicted Gravios", nameJP: "凶異グラビモス", species: "飛龍種", normalAttack: "力量", specialAttacks: "[蓄熱]: 技巧" },
      { name: "兇異風漂龍", nameEN: "Afflicted Legiana", nameJP: "凶異レイギエナ", species: "飛龍種", normalAttack: "速度", specialAttacks: "[異常化]: 力量 / [飛行]: 技巧" },
      { name: "兇異怨虎龍", nameEN: "Afflicted Magnamalo", nameJP: "凶異マガイマガド", species: "牙龍種", normalAttack: "速度", specialAttacks: "[鬼火]: 力量 / [鬼火纏身]: 技巧" },
      { name: "兇異浮岳龍", nameEN: "Afflicted Yama Tsukami", nameJP: "凶異ヤマツカミ", species: "古龍種", normalAttack: "力量", specialAttacks: "[張口]: 速度" },
      { name: "兇異赫猿獸", nameEN: "Afflicted Ajarakan", nameJP: "凶異アジャラカン", species: "牙獸種", normalAttack: "技巧", specialAttacks: "[赤熱化]: 力量" },
      { name: "兇異妃蜘蛛", nameEN: "Afflicted Rakna-Kadaki", nameJP: "凶異ヤツカダキ", species: "蟲蛛種", normalAttack: "技巧", specialAttacks: "[蓄絲(腳)]: 技巧 / [蓄絲(繭)]: 速度" },
      { name: "兇異雪獅子王", nameEN: "Afflicted Blangonga", nameJP: "凶異ドドブランゴ", species: "牙獸種", normalAttack: "力量", specialAttacks: "[憤怒]: 速度" },
    ],
  },
];
