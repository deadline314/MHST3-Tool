...
const RAW_DATA: { category: string; monsters: RawMonster[] }[] = [
  ...
  },
  {
    ...
    monsters: [
      ...
      { name: "兇異怪鳥", nameEN: "Feral Yian Kut-Ku", nameJP: "凶異イャンクック", species: "鳥龍種", normalAttack: "技巧", specialAttacks: "[憤怒]: 速度" },
      { name: "兇異迅猛龍王", nameEN: "Feral Velocidrome", nameJP: "凶異ドスランポス", species: "鳥龍種", normalAttack: "速度", specialAttacks: "[憤怒]: 力量" },
      { name: "兇異彩鳥", nameEN: "Feral Gypceros", nameJP: "凶異ゲリョス", species: "鳥龍種", normalAttack: "力量", specialAttacks: "[憤怒]: 技巧" },
      { name: "兇異人魚龍", nameEN: "Feral Somnacanth", nameJP: "凶異イソネミクニ", species: "海龍種", normalAttack: "技巧", specialAttacks: "[尾立]: 速度" },
      { name: "兇異鐮鼬龍王", nameEN: "Feral Great Izuchi", nameJP: "凶異オサイズチ", species: "鳥龍種", normalAttack: "速度", specialAttacks: "[憤怒]: 力量" },
      { name: "兇異傘鳥", nameEN: "Feral Aknosom", nameJP: "凶異アケノシルム", species: "鳥龍種", normalAttack: "技巧", specialAttacks: "[憤怒]: 力量" },
      { name: "兇異影蜘蛛", nameEN: "Feral Nerscylla", nameJP: "凶異ネルスキュラ", species: "蟲蛛種", normalAttack: "技巧", specialAttacks: "[異常化]: 速度" },
      ...
      { name: "兇異桃毛獸", nameEN: "Feral Bishaten", nameJP: "凶異ビシュテンゴ", species: "牙獸種", normalAttack: "技巧", specialAttacks: "[異常化]: 速度" },
      ...
      { name: "兇異斬龍", nameEN: "Feral Glavenus", nameJP: "凶異ディノバルド", species: "獸龍種", normalAttack: "速度", specialAttacks: "[蓄熱]: 技巧 / [紅刃]: 力量" },
      { name: "兇異鎧龍", nameEN: "Feral Gravios", nameJP: "凶異グラビモス", species: "飛龍種", normalAttack: "力量", specialAttacks: "[蓄熱]: 技巧" },
      { name: "兇異風漂龍", nameEN: "Feral Legiana", nameJP: "凶異レイギエナ", species: "飛龍種", normalAttack: "速度", specialAttacks: "[異常化]: 力量 / [飛行]: 技巧" },
      { name: "兇異怨虎龍", nameEN: "Feral Magnamalo", nameJP: "凶異マガイマガド", species: "牙龍種", normalAttack: "速度", specialAttacks: "[鬼火]: 力量 / [鬼火纏身]: 技巧" },
      { name: "兇異浮岳龍", nameEN: "Feral Yama Tsukami", nameJP: "凶異ヤマツカミ", species: "古龍種", normalAttack: "力量", specialAttacks: "[張口]: 速度" },
      { name: "兇異赫猿獸", nameEN: "Feral Ajarakan", nameJP: "凶異アジャラカン", species: "牙獸種", normalAttack: "技巧", specialAttacks: "[赤熱化]: 力量" },
      { name: "兇異妃蜘蛛", nameEN: "Feral Rakna-Kadaki", nameJP: "凶異ヤツカダキ", species: "蟲蛛種", normalAttack: "技巧", specialAttacks: "[蓄絲(腳)]: 技巧 / [蓄絲(繭)]: 速度" },
      { name: "兇異雪獅子王", nameEN: "Feral Blangonga", nameJP: "凶異ドドブランゴ", species: "牙獸種", normalAttack: "力量", specialAttacks: "[憤怒]: 速度" },
    ],
  },
];
