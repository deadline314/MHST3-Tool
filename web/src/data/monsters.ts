...
const RAW_DATA: { category: string; monsters: RawMonster[] }[] = [
  ...
  },
  {
    ...
    monsters: [
      ...
      { name: "兇異影蜘蛛", nameEN: "Feral Nerscylla", nameJP: "凶異ネルスキュラ", species: "鋏角種", normalAttack: "技巧", specialAttacks: "[憤怒]: 速度" },
      ...
      { name: "兇異妃蜘蛛", nameEN: "Feral Rakna-Kadaki", nameJP: "凶異ヤツカダキ", species: "鋏角種", normalAttack: "技巧", specialAttacks: "[蓄絲(腳)]: 技巧 / [蓄絲(繭)]: 速度" },
