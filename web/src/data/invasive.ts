...
export const INVASIVE_BEASTS: InvasiveBeast[] = [
  { region: "亞茲萊爾領域", location: "明鏡之湖（北邊洞窟，夜間限定）", invasive: "侵獸水龍", invasiveJP: "侵獣ガノトトス", requirement: "火屬性大錘", method: "用火屬性大錘攻擊頭部進行部位破壞即可帰巣。侵化態為技巧型，注意超滅氣攻擊，可用預防旋律防止。HP約40%以下後行動變得混亂，會使用更多全體攻擊", unlocksMonster: "海龍", unlocksMonsterJP: "ラギアクルス", baseMonster: "水龍" },
  { region: "亞茲萊爾領域", location: "明鏡之湖西北懸崖（夜間限定）", invasive: "侵獸千刃龍", invasiveJP: "侵獣セルレギオス", requirement: "有「正面勝負」技能的大錘＋有「見切」技能的太刀＋孵技：太陽之咆哮", method: "前50% HP為安全階段，用太陽之咆哮充滿羈絆值。50%後連續五回合致命全體攻擊，需用見切＋氣刃解放斬閃避破裂刃鱗，再以多隻魔物的羈絆技擋攻擊。咆哮後根據BUFF類型（攻擊↑=力量、速度↑=速度、防禦↑=技巧）判斷豪速鱗的三竦對決類型，用正面勝負勝出", unlocksMonster: "電龍", unlocksMonsterJP: "ライゼクス", baseMonster: "千刃龍" },
  ...
  { region: "卡納爾塔密林", location: "恩惠之丘", invasive: "侵獸青熊獸", invasiveJP: "侵獣アオアシラ", requirement: "-", method: "帰巣條件：耗盡青熊獸的蜂蜜。重點是殺死召喚出的普通青熊獸小怪，而非BOSS本體。若侵化態結束時場上仍有2隻青熊獸，會使出即死全體攻擊（蜂蜜爪）。對異常狀態（毒、爆破、麻痺）極度脆弱", unlocksMonster: "加爾克", unlocksMonsterJP: "ガルク", baseMonster: "青熊獸" },
  ...
  { region: "卡納爾塔密林", location: "瀑布隱藏冰窟（夜間限定）", invasive: "侵獸鎌蟹", invasiveJP: "侵獣ショウグンギザミ", requirement: "同時有守勢之歌與飛躍旋律的笛子＋硬化藥", method: "帰巣條件：①第1回合對隨行獸使用硬化藥 ②第2回合用飛躍旋律將防禦提升至【大】 ③第3回合隨行獸承受侵襲：鐵塊斬。殼（頭蓋骨）型態為力量，侵化速度型，脫殼技巧型。殼型態時有反擊準備，不要攻擊。侵化態攻擊藍/黃線=速度，紅線=鐵塊斬", unlocksMonster: "泡狐龍", unlocksMonsterJP: "タマミツネ", baseMonster: "鎌蟹" },
  { region: "塔基爾坎", location: "奇岩帶西方高台（夜間限定）", invasive: "侵獸慘爪龍", invasiveJP: "侵獣オドガロン", requirement: "泥翁龍（需有掀起泥浪/泥沼地獄技能）＋穿刺武器（弓/銃槍）", method: "帰巣條件：在侵襲：紅蓮爪時同時完成「爪子部位破壞」和「身上有淤泥陷阱DEBUFF」。用穿刺武器一直打爪子，隨行獸持續使用掀起泥浪/泥沼地獄疊泥DEBUFF", unlocksMonster: "雷狼龍", unlocksMonsterJP: "ジンオウガ", baseMonster: "慘爪龍" },
  { region: "塔基爾坎", location: "巨龍之骸東南（夜間限定）", invasive: "侵獸角龍", invasiveJP: "侵獣ディアブロス", requirement: "有「隕星槌」技能的大錘＋孵技：太陽之咆哮", method: "帰巣條件：角龍遁地後左右出現沙塵，用隕星槌砸「最右邊」的目標即可強制倒地＋取消遁地。用太陽之咆哮充滿羈絆值備用。HP約50%後獄咆哮替換為全體攻擊麥克斯角", unlocksMonster: "轟龍", unlocksMonsterJP: "ティガレックス", baseMonster: "角龍" },
  { region: "桑提亞", location: "冰河東北懸崖（夜間限定）", invasive: "侵獸奇怪龍", invasiveJP: "侵獣フルフル", requirement: "有預防旋律的狩獵笛＋耐雷裝備", method: "帰巣條件：不讓竜氣獵食者成功（用雙重對決勝出），撐到第2次侵襲：死亡之聲。①第1-2回合用預防旋律防麻痺 ②第3-4回合贏得雙重對決（速度型對決） ③第5回合部位破壞+同步衝鋒。第2輪第3回合竜氣獵食者變為無屬性，必須用羈絆技擋", unlocksMonster: "冰牙龍", unlocksMonsterJP: "ベリオロス", baseMonster: "奇怪龍" },
];
