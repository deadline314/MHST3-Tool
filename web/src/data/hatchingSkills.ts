...
export const HATCHING_SKILL_DETAILS: Record<string, HatchingSkillDetail> = {
  ...
  "王の裁き": { nameJP: "王の裁き", nameZH: "王之裁決", type: "速度", element: "火屬性", target: "敵單體", stCost: 60, power: 150, dragonBreak: 10, effect: "對單一敵方造成火屬性傷害，有機率賦予燒傷。" },

  "水鏡割り": { nameJP: "水鏡割り", nameZH: "水鏡割", type: "技巧", element: "水屬性", target: "敵單體", stCost: 20, power: 70, dragonBreak: 30, effect: "對單一敵方造成水屬性傷害，並賦予龍氣防禦力降低。" },
  "明鏡止水": { nameJP: "明鏡止水", nameZH: "明鏡止水", type: "無", element: "無屬性", target: "我方全體", stCost: 20, power: "-", dragonBreak: "-", effect: "我方全體賦予破龍力提升。每次使用效果提升。" },
  "激流の渦": { nameJP: "激流の渦", nameZH: "激流之渦", type: "速度", element: "水屬性", target: "敵單體", stCost: 40, power: 120, dragonBreak: 10, effect: "對單一敵方造成水屬性傷害。" },
  "絶海波濤": { nameJP: "絶海波濤", nameZH: "絕海波濤", type: "無", element: "水屬性", target: "敵隨機", stCost: 30, power: 240, dragonBreak: 50, effect: "隨機對敵方全體造成水屬性傷害。" },
  "月輪の咆哮": { nameJP: "月輪の咆哮", nameZH: "月輪的咆哮", type: "無", element: "無屬性", target: "敵方全體", stCost: 20, power: "-", dragonBreak: "-", effect: "解除敵方全體所有增益效果。" },
  ...
  "紫電一閃": { nameJP: "紫電一閃", nameZH: "紫電一閃", type: "力量", element: "雷屬性", target: "敵方全體", stCost: 50, power: 120, dragonBreak: 30, effect: "對敵方全體造成雷屬性傷害。" },
  "憤怒の剛力": { nameJP: "憤怒の剛力", nameZH: "憤怒的剛力", type: "無", element: "無屬性", target: "自身", stCost: 25, power: "-", dragonBreak: "-", effect: "下回合自身對敵人造成的傷害大幅提升。" },
  "雷霆天討": { nameJP: "雷霆天討", nameZH: "雷霆天討", type: "技巧", element: "雷屬性", target: "敵單體", stCost: 35, power: 90, dragonBreak: 20, effect: "對單一敵方造成無視防禦的雷屬性傷害。容易取得先發。" },

  "氷縛撃": { nameJP: "氷縛撃", nameZH: "冰縛擊", type: "速度", element: "冰屬性", target: "敵單體", stCost: 20, power: 80, dragonBreak: 20, effect: "對單一敵方造成冰屬性傷害，賦予速度下降。" },
  "砕氷の型": { nameJP: "砕氷の型", nameZH: "碎冰之型", type: "無", element: "無屬性", target: "自身", stCost: 30, power: "-", dragonBreak: "-", effect: "賦予自身破龍力提升。" },
  "霧氷の疾風": { nameJP: "霧氷の疾風", nameZH: "霧冰的疾風", type: "無", element: "無屬性", target: "我方全體", stCost: 30, power: "-", dragonBreak: "-", effect: "我方全體賦予速度提升。" },
  "氷塊零度": { nameJP: "氷塊零度", nameZH: "冰塊零度", type: "力量", element: "冰屬性", target: "敵單體", stCost: 20, power: 40, dragonBreak: 60, effect: "對單一敵方造成冰屬性傷害，賦予速度下降。" },
  "白雪纏い": { nameJP: "白雪纏い", nameZH: "白雪纏身", type: "無", element: "無屬性", target: "自身", stCost: 40, power: "-", dragonBreak: "-", effect: "賦予自身會心率提升、迴避率提升與速度提升。" },

  "龍門": { nameJP: "龍門", nameZH: "龍門", type: "無", element: "無屬性", target: "我方全體", stCost: 25, power: "-", dragonBreak: "-", effect: "我方全體賦予狀態異常無效。" },
  "牙龍点睛": { nameJP: "牙龍点睛", nameZH: "牙龍點睛", type: "技巧", element: "龍屬性", target: "敵單體", stCost: 45, power: 120, dragonBreak: 10, effect: "對單一敵方造成龍屬性傷害。" },
  "龍轟撃": { nameJP: "龍轟撃", nameZH: "龍轟擊", type: "力量", element: "龍屬性", target: "敵單體", stCost: 25, power: 50, dragonBreak: 40, effect: "對單一敵方造成龍屬性傷害。自身殘餘HP越低威力越高。" },
  "大落龍": { nameJP: "大落龍", nameZH: "大落龍", type: "無", element: "龍屬性", target: "敵隨機", stCost: 50, power: 360, dragonBreak: 30, effect: "隨機對敵方全體造成龍屬性傷害。" },
  "古龍の威圧": { nameJP: "古龍の威圧", nameZH: "古龍的威壓", type: "無", element: "無屬性", target: "敵方全體", stCost: 30, power: "-", dragonBreak: "-", effect: "對敵方全體賦予攻擊力下降與防禦力下降。每次使用效果提升。" },
};
